...
cls
echo ====================================================
echo                PXNG Tweaks Free V4                
echo ====================================================
echo Welcome to PXNG Tweaks Free V4! Before proceeding,
echo we recommend creating a system restore point to ensure
echo you can easily revert back if anything goes wrong.
echo ====================================================
echo 1. Yes, create a restore point
echo 2. No, skip and continue
echo ====================================================
set /p confirm="Do you want to create a restore point? (1 - Yes / 2 - Skip): "

if "%confirm%"=="1" goto create_restore_point
if "%confirm%"=="2" goto main
goto start
...
echo ====================================================
echo This process will create a system restore point
echo so you can restore your system to its current state 
echo if needed.
echo ====================================================
set /p confirm="Do you want to create a restore point now? (Y/N): "

if /i "%confirm%"=="Y" goto perform_restore_point
if /i "%confirm%"=="N" goto main
goto create_restore_point

:perform_restore_point
cls
echo Creating System Restore Point...
powershell.exe -Command "Checkpoint-Computer -Description 'Pre-Tweaks Restore Point' -RestorePointType 'MODIFY_SETTINGS'"
if %errorlevel%==0 (
    echo Restore Point created successfully!
) else (
    echo Failed to create Restore Point. Please ensure that System Protection is enabled.
)
pause
goto main
...
echo                PXNG Tweaks Free V4
echo ====================================================
echo Welcome to PXNG Tweaks Free V4! A powerful tool 
echo designed to boost your system's performance. 
echo ====================================================
echo 1. CPU Tweaks
echo 2. GPU Tweaks
echo 3. RAM Tweaks
echo 4. Ethernet Tweaks
echo 5. Windows Tweaks
echo 6. General Optimizations
echo 7. About PXNG
echo 8. Exit
echo ====================================================
...
if "%choice%"=="6" goto general_optimizations
if "%choice%"=="7" goto about_pxng
if "%choice%"=="8" exit
goto main
...
echo ====================================================
set /p general_choice="Select an option: "

if "%general_choice%"=="1" goto General Optimizations
if "%general_choice%"=="2" goto main
goto general_optimizations
...
echo              General Optimizations              
echo ====================================================
echo This is the section where you can add your custom
echo tweaks. Modify this part to suit your needs. 
echo ====================================================
:: Example custom tweak
echo Adding your custom tweaks here...
:: Place your tweaks or scripts below:
cls
echo.                                                                                                                          
echo.                                                                                                                                                                                                                                                                                                                                   
echo.                                                               
...
chcp 65001 > nul
chcp 437 > nul
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('select adjust for best performanceAnd select Show Thumbnails Instead of icans, smooth edges on screen fonts and press apply', 'PXNG TWEAKS', 'Ok', [System.Windows.Forms.MessageBoxIcon]::Information);}"
chcp 65001 > nul
...
reg add "HKCU\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" /v "ShowFirstSignInExperience" /t REG_DWORD /d 0 /f
if %errorlevel% neq 0 (
    echo Failed to apply custom tweak!
) else (
    echo Custom tweak applied successfully!
)
pause
goto general_optimizations
...
echo                  CPU Tweaks                          
echo ====================================================
echo 1. Optimize Power Plan for Performance
echo 2. Disable Core Parking
echo 3. Disable Background Processes
echo 4. Apply All CPU Tweaks
echo 5. Back to Main Menu
echo ====================================================
set /p cpu_choice="Select an option: "

if "%cpu_choice%"=="1" goto cpu_power_plan
if "%cpu_choice%"=="2" goto cpu_core_parking
if "%cpu_choice%"=="3" goto cpu_background_processes
if "%cpu_choice%"=="4" goto apply_all_cpu_tweaks
if "%cpu_choice%"=="5" goto main
goto cpu_tweaks

:cpu_power_plan
cls
echo Applying Power Plan Optimization...
powercfg -setactive SCHEME_MIN
if %errorlevel% neq 0 (
    echo Failed to apply power plan optimization!
) else (
...
for /f "tokens=*" %%G in ('REG QUERY "HKLM\SYSTEM\CurrentControlSet\Services\Processor" /v "Performance"') do echo %%G | findstr /i "ProcessorPerformanceCoreParking" >nul || (
    reg add "HKLM\SYSTEM\CurrentControlSet\Services\Processor" /v "ProcessorPerformanceCoreParking" /t REG_DWORD /d 0 /f
)
if %errorlevel% neq 0 (
    echo Failed to disable core parking!
) else (
    echo Core Parking has been disabled!
)
pause
goto cpu_tweaks

:cpu_background_processes
cls
echo Disabling unnecessary background processes...
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\GameDVR" /v "AppCaptureEnabled" /t REG_DWORD /d 0 /f
if %errorlevel% neq 0 (
    echo Failed to disable background processes!
) else (
...
:apply_all_cpu_tweaks
cls
echo Applying All CPU Tweaks...
powercfg -setactive SCHEME_MIN
if %errorlevel% neq 0 (
    echo Failed to apply power plan optimization!
) else (
...
reg add "HKCU\SOFTWARE\Microsoft\Windows\CurrentVersion\GameDVR" /v "AppCaptureEnabled" /t REG_DWORD /d 0 /f
if %errorlevel% neq 0 (
    echo Failed to apply all CPU tweaks!
) else (
    echo All CPU tweaks applied successfully!
)
pause
goto main
...
echo                  GPU Tweaks                          
echo ====================================================
echo 1. Optimize GPU Performance
echo 2. Disable Unnecessary GPU Features
echo 3. Enable Hardware Acceleration
echo 4. Back to Main Menu
echo ====================================================
set /p gpu_choice="Select an option: "

if "%gpu_choice%"=="1" goto gpu_optimize
if "%gpu_choice%"=="2" goto gpu_disable_features
if "%gpu_choice%"=="3" goto enable_hardware_acceleration
if "%gpu_choice%"=="4" goto main
goto gpu_tweaks

:gpu_optimize
cls
echo Optimizing GPU for performance...
nvidia-smi --gpu-target-ops=high
if %errorlevel% neq 0 (
    echo Failed to optimize GPU!
) else (
...
:gpu_disable_features
cls
echo Disabling unnecessary GPU features...
reg add "HKCU\Software\Microsoft\Direct3D" /v "EnableBloom" /t REG_DWORD /d 0 /f
if %errorlevel% neq 0 (
    echo Failed to disable unnecessary GPU features!
) else (
    echo Unnecessary GPU features disabled!
)
pause
goto gpu_tweaks
...
reg add "HKCU\Software\Microsoft\Internet Explorer\Main" /v "EnableHardwareAcceleration" /t REG_DWORD /d 1 /f
if %errorlevel% neq 0 (
    echo Failed to enable hardware acceleration!
) else (
...
echo                  RAM Tweaks                          
echo ====================================================
echo 1. Optimize Virtual Memory (Pagefile)
echo 2. Adjust Memory Priority
echo 3. Set RAM size-based optimizations
echo 4. Back to Main Menu
echo ====================================================
set /p ram_choice="Select an option: "

if "%ram_choice%"=="1" goto ram_pagefile
if "%ram_choice%"=="2" goto ram_priority
if "%ram_choice%"=="3" goto ram_size_based_tweaks
if "%ram_choice%"=="4" goto main
goto ram_tweaks
...
wmic pagefilesetting where name="C:\\pagefile.sys" set InitialSize=2048,MaximumSize=8192
if %errorlevel% neq 0 (
    echo Failed to optimize pagefile!
) else (
    echo Pagefile optimized for performance!
)
pause
goto ram_tweaks
...
:ram_priority
cls
echo Adjusting Memory Priority...
reg add "HKLM\SYSTEM\CurrentControlSet\Control\PriorityControl" /v "Win32PrioritySeparation" /t REG_DWORD /d 26 /f
if %errorlevel% neq 0 (
    echo Failed to adjust memory priority!
) else (
    echo Memory priority adjusted successfully!
)
pause
goto ram_tweaks
...
cls
echo ====================================================
echo                  Ethernet Tweaks                    
echo ====================================================
echo 1. Optimize Network Latency
echo 2. Apply Network Adapter Tweaks
echo 3. Back to Main Menu
echo ====================================================
set /p ethernet_choice="Select an option: "

if "%ethernet_choice%"=="1" goto optimize_latency
if "%ethernet_choice%"=="2" goto adapter_tweaks
if "%ethernet_choice%"=="3" goto main
goto ethernet_tweaks
...
if %errorlevel% neq 0 (
    echo Failed to optimize network latency!
) else (
...
:adapter_tweaks
cls
echo Applying Network Adapter Tweaks...
netsh int tcp set global autotuninglevel=disable
netsh int tcp set global rss=enabled
if %errorlevel% neq 0 (
    echo Failed to apply network adapter tweaks!
) else (
    echo Network Adapter Tweaks applied!
)
pause
goto ethernet_tweaks
...
echo 2. Back to Main Menu
echo ====================================================
set /p win_choice="Select an option: "

if "%win_choice%"=="1" goto windows10_tweaks
if "%win_choice%"=="2" goto main
goto windows_tweaks
...
echo 2. Disable Animations
echo 3. Disable Cortana
echo 4. Optimize for Gaming
echo 5. Back to Windows Tweaks
echo ====================================================
set /p win10_choice="Select an option: "

if "%win10_choice%"=="1" goto disable_transparency_10
if "%win10_choice%"=="2" goto disable_animations_10
if "%win10_choice%"=="3" goto disable_cortana_10
if "%win10_choice%"=="4" goto optimize_gaming_10
if "%win10_choice%"=="5" goto windows_tweaks
goto windows10_tweaks

:disable_transparency_10
cls
echo Disabling Transparency...
reg add "HKCU\Software\Microsoft\Windows\DWM" /v "EnableAeroGlass" /t REG_DWORD /d 0 /f
if %errorlevel% neq 0 (
...
if %errorlevel% neq 0 (
    echo Failed to disable Cortana!
) else (
...
cls
echo ====================================================
echo                About PXNG Tweaks                    
echo ====================================================
echo PXNG Tweaks Free V4 is a powerful tool designed
echo to enhance the performance and stability of your 
echo Windows system through various optimizations.
echo Developed by: PXNG Team
echo ====================================================
pause
goto main
